...
Previous band 7 observations with rms of 25uJy and resolution of 0.8arcsec (Lovell+2021), similar to 12mSB

old:
- 12mLB cycle 3 0.3" resolution with 2 executions in July 2016, rms of 88uJy.
- 12mSB cycle 5 0.8" resolution with 2 executions in 27 of June and 7 of July 2018, rms of 25uJy

arks:
- ACA observed with 6 execution blocks in October 2022, rms of 290uJy
- 12m c40-3 observed with 1 execution blocks in October 2022, rms of 24uJy, 0.8"
- 12m c40-6 observed with 4 execution blocks in May 2024, rms of 36uJy, 0.3"
...
### system parameters
system={'target'      : 'HD10647', # used to name files
        'field_name'  : 'HD10647', # field name in ms
...
#         'Radius'      : 28., # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 500 au or at least 2x disc outer edge      
        'rv'       : 27.64, # km/s, radial velocity in barycentric reference frame from Gaia DR3
        'dvel'        : 50.0,      # km/s, line width. It is used to flag channels at +-dvel and to image a cube with a width of +-3dvel
        }

system2={'target'      : 'HD10647', # used to name files
        'field_name'  : 'q1_Eri', # field name in ms
        'Radius'      : 16.4, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to FWHM of Antenna primary beam    
#         'Radius'      : 28., # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 500 au or at least 2x disc outer edge      
        'rv'       : 27.64, # km/s, radial velocity in barycentric reference frame from Gaia DR3
        'dvel'        : 50.0,      # km/s, line width. It is used to flag channels at +-dvel and to image a cube with a width of +-3dvel
...
do_mstransform = True  # remove calibrators and change to BARY reference frame
do_flag=True

# continuum
do_select_cont = True  # select continuum by flagging
...
if do_flag: # flag baselines from antenna pair DA46&DA54 in obs 1 to ro remove fringes.
    msf='{}.{}.obs1.cal.bary.ms'.format(system2['target'],cfg)
    flagdata(msf,  antenna='DA46&DA54', flagbackup=False)
