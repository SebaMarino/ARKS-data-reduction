...
### system parameters
system={'target'      : 'HD15115', # used to name files
        'field_name'  : 'HD15115', # field name in ms
        'Radius'      : 10.3, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 600 au or at least 2x disc outer edge 
        'rv'       : 6.91, # km/s, radial velocity in barycentric reference frame from Gaia DR3
