...
- 12m c40-3 observed with 1 execution block in October 2022
- 12m c40-6 observed with 3 execution blocks in Apr-May 2023
...
### system parameters
system={'target'      : 'HD61005', # used to name files
        'field_name'  : 'HD61005', # field name in ms
        ...
        'Radius'      : 13.7, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 500 au or at least 2x disc outer edge   
        'rv'       : 22.35, # km/s, radial velocity in barycentric reference frame from Gaia DR3
