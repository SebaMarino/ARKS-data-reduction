...
- ACA observed with 3 executions in October  2022
- 12m c40-3 observed with 2 execution blocks in January 2023
...
### system parameters
system={'target'      : 'HD170773', # used to name files
        'field_name'  : 'HD170773', # field name in ms
        ...
        'rv'       : -17.75, # km/s, radial velocity in barycentric reference frame from Gaia DR3
