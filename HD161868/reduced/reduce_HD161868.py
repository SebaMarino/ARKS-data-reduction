...
- ACA observed with 11 executions on October 2022
- 12m c40-2 observed with 3 execution blocks on 1 and 7 Oct 2022
...
### system parameters
system={'target'      : 'HD161868', # used to name files
        'field_name'  : 'HD161868', # field name in ms
        ...
        'rv'       : -7.6, # km/s, radial velocity in barycentric reference frame from Gaia DR3
