...
Target: TYC9340-437-1

No previous band 7 observations

- ACA observed with 4 executions on 3 and 4 of Oct 2022
- 12m c40-3 observed with 2 execution blocks on 1 Oct 2022 
...
### system parameters
system={'target'      : 'TYC9340', # used to name files
        'field_name'  : 'TYC9340-437-1', # field name in ms
        ...
        'rv'       : 7.0229354, # km/s, radial velocity in barycentric reference frame from Gaia DR3
