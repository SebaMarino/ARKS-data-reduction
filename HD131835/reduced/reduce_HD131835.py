...
Previous band 7 observations by project 2013.1.01166.S (PI: Michel Cure) at resolution of 0.3" and sensitivity of 40uj/beam, so poorer than our compact observations (0.45" and 26uJy/beam).

- 12m c40-3 observed with 2 execution blocks on 23 and 24 December 2023
- 12m c40-6 observed with 9 execution blocks on April and May 2023
...
### system parameters
system={'target'      : 'HD131835', # used to name files
        'field_name'  : 'HD131835', # field name in ms
#         'Radius'      : 16.4, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to FWHM of Antenna primary beam    
        'Radius'      : 3.9, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 500 au or at least 2x disc outer edge   

        'rv'       : -1.97, # km/s, radial velocity in barycentric reference frame from Gaia DR3
