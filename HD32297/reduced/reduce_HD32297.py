...
Previous band 7 observations published by Gianni Cataldi with 0.73" resolution and 0.028uJy continuum sensitivity

- 12m c40-4 observed with 
- 12m c40-7 observed with 4 execution blocks in June and September 2023
...
### system parameters
system={'target'      : 'HD32297', # used to name files
        'field_name'  : 'HD32297', # field name in ms
        ...
        'rv'       : 19.38, # km/s, radial velocity in barycentric reference frame from Gaia DR3
