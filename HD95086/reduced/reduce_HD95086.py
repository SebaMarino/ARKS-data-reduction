...
Previous band 7 observations by project 2016.A.00021.T and published in Zapata+2018

- 12m c40-3 observed with 3 execution blocks on January 2023
...
### system parameters
system={'target'      : 'HD95086', # used to name files
        'field_name'  : 'HD95086', # field name in ms
        ...
        'rv'       : 18., # km/s, radial velocity in barycentric reference frame from Gaia DR3
