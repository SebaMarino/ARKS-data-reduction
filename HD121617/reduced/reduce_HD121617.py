...
- 12m c40-3 observed with 2 execution block on 7 Oct 2022 
- 12m c40-6 observed with 7 execution blocks on April and May 2023
...
### system parameters
system={'target'      : 'HD121617', # used to name files
        'field_name'  : 'HD121617', # field name in ms
        ...
        'Radius'      : 4.2, # arcsec, maximum radius of interest used to calculate maximum freq and time averaging. Set to 500 au or at least 2x disc outer edge   
        'rv'       : 5.93, # km/s, radial velocity in barycentric reference frame from Gaia DR3
