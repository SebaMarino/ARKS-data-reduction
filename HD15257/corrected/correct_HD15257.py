...
- ACA observed with 11 executions on 6 Oct 2022
- 12m c40-2 observed with 4 execution blocks on 18 Oct 2022
...
if do_correct:
    for i, obi in enumerate(obtags):
        ...
        # continuum time and frequency averaged
...
if do_concat:
    ...
    for i in range(len(cfgs)):
        for sufix in sufixes:
            ...
            concatenate(ms_files, concatvis='{}.{}.cal.bary.{}.ms'.format(target, cfgs[i], sufix), refdir=direction)
