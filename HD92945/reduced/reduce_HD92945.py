...
Target: HD92945 (archival)

- ACA observed with 5 executions in 2016 and 2017.
- 12m c40-3 observed with 3 execution blocks in Dec 2016
...
### system parameters
system={'target'      : 'HD92945', # used to name files
        'field_name'  : 'hd92945', # for ACA, field name in ms
        ...
        'rv'       : 22.57, # km/s, radial velocity in barycentric reference frame from Gaia DR3
