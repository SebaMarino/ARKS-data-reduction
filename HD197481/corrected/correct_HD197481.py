...
if do_extractvis_ind:
    
    for i in range(Nms[0]):
        
        uvtable_filename='{}.{}.obs{}.continuum.fav.tav.corrected.txt'.format(target, cfgs[0], i+1)
        os.system('rm '+uvtable_filename)
        extract_visibilities('{}.{}.obs{}.cal.bary.continuum.fav.tav.corrected.ms'.format(target, cfgs[0], i+1), uvtable_filename)
